...
import OtherProfileGoodsWindow
  from "@/components/otherAndYourProfileComponents/otherProfileComponents/otherProfileGoodsWindow.vue";
...
<template>
  <div>
    ...
    <div id="goodsWindowsContainer">
      <other-profile-goods-window v-for="good in paginatedGoods" :key="good.id" :good="good"/>
    </div>
